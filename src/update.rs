...
impl Map {
    ...
    pub fn update_px(&mut self, col: i32, row: i32, player: &Player) {
        ...
        // if  num > 90.0 || (player.get_view_port().contains(Vec2::new(col as f32, row as f32)) && num > 90.0) {
